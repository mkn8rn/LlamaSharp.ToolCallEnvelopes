...
/// <para>
/// C# port of llama.cpp's reference <c>json-schema-to-grammar</c>.
...
/// </para>
/// </summary>
public static class LlamaSharpJsonSchemaConverter
{
    ...
    /// <summary>
    /// Clears the process-local schema grammar cache.
    /// </summary>
    public static void ResetCache() => _grammarCache.Clear();
}
